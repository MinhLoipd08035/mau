...
$ma_hh = $_REQUEST['idpro'];
$show_binhluan = list_binhluan_sp($ma_hh);
...
<body>
    <div class="comment-container">
        <div id="binh_luan">
            ...
            foreach ($show_binhluan as $binhluan2) {
                ...
                echo "<p class='no'>($ngay_bl)</p><p class='bold'>$ten_kh:</p>";
                echo "<p>$noi_dung</p>";
                echo "</div>";
        ...
        if (isset($_SESSION['khach_hang'])) {
            ...
            <input type="hidden" name="ten_kh" value="' . $ten_kh . '">
            ...
            // The user is not logged in, display a message or redirect to a login page
            echo 'Vui lòng <a href="index.php?act=dangnhap" style="color: blue; text-decoration: underline;">đăng nhập</a> để bình luận.';
        }
        ?>
    ...
    if (isset($_POST['gui_binhluan']) && ($_POST['gui_binhluan'])) {
        ...
        them_binhluan($noi_dung, $ma_hh, $ma_kh, $ngay_bl, $ten_kh);
